  ...
  initialState: [
    {
      ...
      answer:
        "小浣熊的私噗是不開放的，如果有委託需求，請至特定噗文留言或是代購噗直接留言，小浣熊看到就會私噗給您，其他有提供臉書粉絲專頁平台可私訊詢問。",
    },
    {
      question: "請問是否可以使用中信ATM無卡匯款？",
      answer: "很抱歉，自2023年03月起，不接受中信ATM無卡存款當作付款方式。",
    },
    {
    ...
    },
    {
      question: "退款時需要手續費嗎？",
      answer:
        "收取退款帳號若為中國信託銀行以外帳號，皆會扣除轉帳手續費退款。手續費為10～15元不等。",
    },
    {
      question: "請問小浣熊有什麼商品／服務無法幫忙代購或幫助呢？",
      answer:
        "一般國際禁運品、單獨代收包裹、單獨日幣代匯款、代付款、醫藥用品代購（含隱形眼鏡）、需冷藏／冷凍配送的商品、全額取貨付款。※可代購香水、無線耳機等，有額外收費。",
    },
    {
